...
public partial class TexturesFogOfWar : ExampleHelper
{
    ...
    public static int Example()
    {
        ...
        RenderTexture fogOfWar = LoadRenderTexture((int)map.tilesX, (int)map.tilesY);
        ...
        BeginDrawing();
        {
            ...
            for (int y = 0; y < map.tilesY; y++)
            {
                for (int x = 0; x < map.tilesX; x++)
                {
                    ...
                    DrawRectangle(x * MAP_TILE_SIZE, y * MAP_TILE_SIZE, MAP_TILE_SIZE, MAP_TILE_SIZE, (map.tileIds[(y * map.tilesX) + x] == 0) ? Blue : Fade(Blue, 0.9f));
            ...
            DrawTexture(
                fogOfWar.Texture,
                new(0, 0, fogOfWar.Texture.Width, -fogOfWar.Texture.Height),
            ...
            DrawText($"Current tile: [{playerTileX},{playerTileY}]", 10, 10, 20, Lime);
        }
        EndDrawing();
