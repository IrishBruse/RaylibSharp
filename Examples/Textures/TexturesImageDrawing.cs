...
public partial class TexturesImageDrawing : ExampleHelper
{
    ...
    public static int Example()
    {
        ...
        ImageDraw(ref parrots, cat, new(0, 0, cat.Width, cat.Height), new(30, 40, cat.Width * 1.5f, cat.Height * 1.5f), White);
        ImageCrop(ref parrots, new(0, 50, parrots.Width, (float)parrots.Height - 100)); // Crop resulting image
        ...
        ImageDrawText(ref parrots, font, "PARROTS ref  CAT", new(300, 230), font.BaseSize, -2, White);
