...
public partial class AudioStreamEffects : ExampleHelper 
{
    ...
    static uint delayBufferSize = 0;
    static uint delayReadIndex = 2;
    static uint delayWriteIndex = 0;

    // Module Functions Declaration
    static static void AudioProcessEffectLPF(System.IntPtr buffer, uint frames);   // Audio effect: lowpass filter
    static static void AudioProcessEffectDelay(System.IntPtr buffer, uint frames); // Audio effect: delay
    ...
    static static void AudioProcessEffectLPF(System.IntPtr buffer, uint frames)
    {
    ...
    // Audio effect: delay
    static static void AudioProcessEffectDelay(System.IntPtr buffer, uint frames)
    {
        for (uint i = 0; i < frames*2; i += 2)
        {
