...
private const int MAP_SIZE = 10;
    ...
    public static int Example()
    {
        ...
        Camera camera = new();
        camera.Position = (Vector3)new(4.0f,6.0f, 8.0f);    // Camera position
        ...
        material.Maps[MaterialMapIndex.Albedo].texture = texture;
        material.Maps[MaterialMapIndex.Metalness].texture = lightmap.texture;
