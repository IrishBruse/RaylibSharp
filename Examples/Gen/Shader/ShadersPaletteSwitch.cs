...
private const int VALUES_PER_COLOR = 3;
    ...
    static const int [] palettes = new int [MAX_PALETTES][COLORS_PER_PALETTE*VALUES_PER_COLOR]{
        {   // 3-BIT RGB
            0, 0, 0,
            255, 0, 0,
            0, 255, 0,
    ...
    public static int Example()
    {
        ...
        while (!WindowShouldClose())            // Detect window close button or ESC key
        {
            ...
            SetShaderValue(shader, paletteLoc, palettes[currentPalette], SHADER_UNIFORM_IVEC3, COLORS_PER_PALETTE);
