...
private const int GLSL_VERSION = 100;
    ...
    public static int Example()
    {
        ...
        Camera camera = new();
        camera.Position = (Vector3)new(8.0f,8.0f, 8.0f);    // Camera position
        camera.Target = (Vector3)new(0.0f,1.5f, 0.0f);      // Camera looking at point
        ...
        float [] swirlCenter = new float [2]new( (float)screenWidth/2, (float)screenHeight/2 );
