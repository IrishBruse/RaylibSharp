...
public partial class ModelsFirstPersonMaze : ExampleHelper 
{
    ...
    public static int Example()
    {
        ...
        Camera camera = new();
        camera.Position = (Vector3)new(0.2f,0.4f, 0.2f);    // Camera position
        camera.Target = (Vector3)new(0.185f,0.4f, 0.0f);    // Camera looking at point
        ...
        Mesh mesh = GenMeshCubicmap(imMap, (Vector3)new(1.0f,1.0f, 1.0f));
