...
public partial class TextUnicode : ExampleHelper 
{
...
private const int EMOJI_PER_HEIGHT = 4;
    ...
    string const emojiCodepoints = "\xF0\x9F\x8C\x80\x00\xF0\x9F\x98\x80\x00\xF0\x9F\x98\x82\x00\xF0\x9F\xA4\xA3\x00\xF0\x9F\x98\x83\x00\xF0\x9F\x98\x86\x00\xF0\x9F\x98\x89\x00"
    ...
    static static void RandomizeEmoji(void);    // Fills the emoji array with random emojis
    ...
    } emoji[EMOJI_PER_WIDTH*EMOJI_PER_HEIGHT] = new();
    ...
    public static int Example()
    {
        ...
        InitWindow(screenWidth, screenHeight, "RaylibSharp - text - unicode");
        ...
        while (!WindowShouldClose())    // Detect window close button or ESC key
        {
            ...
            BeginDrawing();{
                ...
                if (selected != -1)
                {
                    ...
                    RectangleF msgRect = new( selectedPos.X - 38.8f, selectedPos.Y, 2 * horizontalPadding + sz.X, 2 * verticalPadding + sz.Y );
    ...
    static static void RandomizeEmoji(void)
    {
        hovered = selected = -1;
        ...
        for (int i = 0; i < SIZEOF(emoji); ++i)
        {
            ...
            emoji[i].color = Fade(ColorFromHS((float)((start*(i + 1))%360), 0.6f, 0.85f), 0.8f);
