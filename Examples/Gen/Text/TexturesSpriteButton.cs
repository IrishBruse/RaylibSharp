...
private const int NUM_FRAMES = 3;
    ...
    public static int Example()
    {
        ...
        RectangleF sourceRec = new( 0, 0, (float)button.Width, frameHeight );

        // Define button bounds on screen
        RectangleF btnBounds = new( screenWidth/2.0f - button.Width/2.0f, screenHeight/2.0f - button.Height/NUM_FRAMES/2.0f, (float)button.Width, frameHeight );
