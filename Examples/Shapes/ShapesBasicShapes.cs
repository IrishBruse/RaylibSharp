    ...
    public static int Example()
    {
        ...
        while (!WindowShouldClose())    // Detect window close button or ESC key
        {
            ...
            BeginDrawing();{
                ...
                DrawTriangle(new( screenWidth/4.0f *3.0f, 80.0f ),
                             new( screenWidth/4.0f *3.0f - 60.0f, 150.0f ),
                             new( screenWidth/4.0f *3.0f + 60.0f, 150.0f ), Violet);

                DrawTriangleLines(new( screenWidth/4.0f*3.0f, 160.0f ),
                                  new( screenWidth/4.0f*3.0f - 20.0f, 230.0f ),
                                  new( screenWidth/4.0f*3.0f + 20.0f, 230.0f ), DarkBlue);
