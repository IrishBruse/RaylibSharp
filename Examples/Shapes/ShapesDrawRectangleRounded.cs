...
public partial class ShapesDrawRectangleRounded : ExampleHelper 
{
    ...
    public static int Example()
    {
        ...
        {
            // Update
            RectangleF rec = new( ((float)GetScreenWidth() - width - 250)/2, (GetScreenHeight() - height)/2.0f, (float)width, (float)height );
            ...
            BeginDrawing();{
                ...
                if (drawRect) DrawRectangle(rec, Fade(Gold, 0.6f));
                ...
                // Draw GUI controls
                width = (int)GuiSliderBar(new( 640, 40, 105, 20 ), "Width", null, (float)width, 0, (float)GetScreenWidth() - 300);
                height = (int)GuiSliderBar(new( 640, 70, 105, 20 ), "Height", null, (float)height, 0, (float)GetScreenHeight() - 50);
                roundness = GuiSliderBar(new( 640, 140, 105, 20 ), "Roundness", null, roundness, 0.0f, 1.0f);
                lineThick = (int)GuiSliderBar(new( 640, 170, 105, 20 ), "Thickness", null, (float)lineThick, 0, 20);
                segments = (int)GuiSliderBar(new( 640, 240, 105, 20), "Segments", null, (float)segments, 0, 60);
