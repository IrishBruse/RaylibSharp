...
public partial class CoreWindowLetterbox : ExampleHelper
{
    ...
    public static int Example()
    {
        ...
        InitWindow(windowWidth, windowHeight, "RaylibSharp [core] example - window scale letterbox");
        ...
        while (!WindowShouldClose())        // Detect window close button or ESC key
        {
            ...
            virtualMouse = Vector2Clamp(virtualMouse, new(0, 0), new((float)gameScreenWidth, (float)gameScreenHeight));
