...
public static unsafe partial class Raylib
{
    ...
    public static partial void InitWindow(int width, int height, [MarshalAs(UnmanagedType.LPStr)] string title);
    ...
    [LibraryImport("raylib")]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool IsWindowState(uint flag);
    ...
    [LibraryImport("raylib")]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool IsGamepadButtonDown(int gamepad, int button);
    ...
    [LibraryImport("raylib")]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool IsMouseButtonReleased(int button);

    /// <summary> Check if a mouse button is NOT being pressed </summary>
    [LibraryImport("raylib")]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool IsMouseButtonUp(int button);
    ...
    [LibraryImport("raylib")]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool TextIsEqual([MarshalAs(UnmanagedType.LPStr)] string text1, [MarshalAs(UnmanagedType.LPStr)] string text2);
    ...
    [LibraryImport("raylib")]
    public static partial void DrawBillboardRec(Camera3D camera, Texture texture, RectangleF source, Vector3 position, Vector2 size, [MarshalUsing(typeof(ColorMarshaller))] Color tint);

    /// <summary> Draw a billboard texture defined by source and rotation </summary>
    [LibraryImport("raylib")]
    public static partial void DrawBillboardPro(Camera3D camera, Texture texture, RectangleF source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, [MarshalUsing(typeof(ColorMarshaller))] Color tint);
